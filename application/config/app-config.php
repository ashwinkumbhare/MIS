...
*
*/
define('APP_BASE_URL', 'https://daynightassistance.com/MIS/');
...
*/
define('APP_ENC_KEY', 'a6059e09681a0c7f132a6aaf7dc7f8b3');
 ...
 */
define('APP_DB_USERNAME', 'ensivoso_MISPerfex');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'MISPerfex@123');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'ensivoso_MISPerfex');
