...
class Landingpage extends AdminController
{
    ...
    public function builder()
    {
        ...
        if (!has_permission('perfex_saas_settings', '', 'edit')) {
        ...
        $data['controllerUrl'] = admin_url(PERFEX_SAAS_ROUTE_NAME . '/landingpage');
    ...
    public function page($action = '')
    {
        // Check for permission
        if (!has_permission('perfex_saas_settings', '', 'edit')) {
            return $this->showError(_l('perfex_saas_permission_denied'));
        }
