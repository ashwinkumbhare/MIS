...
class File_sharing_client extends ClientsController
{
  ...
  public function new_root_main(){
    ...
    if (!is_dir($mediaPath)) {
      ...
      fs_new_file_database($mediaPath, 1,'','','directory');
    }
    ...
    if($config){
      ...
      if (!is_dir($publicRootPath)) {
        ...
        fs_new_file_database($publicRootPath, 1,'','','directory');
      }
      ...
      if (!is_dir($path)) {
          mkdir($path, 0755);
          fs_new_file_database($path, 1, '', '', 'directory');
      }
      ...
      if (!is_dir($sharePath)) {
          ...
          fs_new_file_database($sharePath, 1, '', '', 'directory');
      }
      ...
      //folder trash of staff
        ...
        if (!is_dir($trashPath)) {
            ...
            fs_new_file_database($trashPath, 1, '', '', 'directory');
        }
